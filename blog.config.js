...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Scott', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Becoming a better version of myself🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.scottstudio.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Scott Studo, Blog', // 网站关键词 英文逗号隔开
